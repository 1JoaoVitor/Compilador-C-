...
C_SRC = $(SRC_DIR)/main.c $(SRC_DIR)/util.c $(SRC_DIR)/analyze.c src/codegen.c

# Objetos gerados
OBJS = $(OBJ_DIR)/parser.tab.o $(OBJ_DIR)/lex.yy.o $(OBJ_DIR)/main.o $(OBJ_DIR)/util.o $(OBJ_DIR)/symtab.o $(OBJ_DIR)/analyze.o obj/codegen.o
...
$(OBJ_DIR)/codegen.o: $(SRC_DIR)/codegen.c
	$(CC) $(CFLAGS) -c $(SRC_DIR)/codegen.c -o $@
