...
{
       0,    64,    64,    68,    70,    74,    75,    78,    84,    93,
     100,   101,   104,   114,   115,   118,   120,   124,   130,   138,
     146,   149,   152,   155,   158,   159,   160,   161,   162,   165,
     166,   167,   174,   180,   189,   197,   199,   206,   213,   216,
     221,   229,   236,   239,   240,   241,   242,   243,   244,   247,
     254,   257,   258,   261,   268,   271,   272,   275,   276,   277,
     278,   285,   293,   294,   297,   299
};
#endif
...
#line 131 "src/parser.y"
     {
         (yyval.node) = newDecNode(ParamK);
         (yyval.node)->type = ((yyvsp[-3].op) == INT) ? Integer : Void; 
